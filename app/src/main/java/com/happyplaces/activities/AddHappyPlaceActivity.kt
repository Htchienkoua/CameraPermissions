...
//verifyin g if the device can access your location 
     ...
     */
    @SuppressLint("MissingPermission") // to suppress the IDE alert for the user permission for location permission
    private fun requestNewLocationData() {

        val mLocationRequest = LocationRequest()

        // check out the different priority choices and battery life specifications
        mLocationRequest.priority = LocationRequest.PRIORITY_HIGH_ACCURACY
        mLocationRequest.interval = 0  // in milliseconds
